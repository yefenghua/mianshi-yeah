...
import com.example.config.WxOpenConfig;
...
import static com.example.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<Boolean> addUserSignIn(@RequestBody UserUpdateMyRequest userUpdateMyRequest,
                                               HttpServletRequest request) {
    ...
    public BaseResponse<List<Integer>> getUserSignInRecord(Integer year,HttpServletRequest request) {
        User loginUser = userService.getLoginUser(request);
        List<Integer> record = userService.getUserSignInRecord(loginUser.getId(), year);
